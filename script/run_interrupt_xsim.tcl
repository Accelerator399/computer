...
puts [exec xelab tb_interrupt -debug typical --timescale 1ns/1ps --override_timeunit --override_timeprecision -s tb_interrupt_sim]
puts [exec xsim tb_interrupt_sim -runall]
