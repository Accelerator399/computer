...
set srcs {
    ...
    src/tb/tb_computer_smode_plic_irq.v
}
...
puts [exec xelab tb_computer_smode_plic_irq -debug typical --timescale 1ns/1ps --override_timeunit --override_timeprecision -s tb_computer_smode_plic_irq_sim]
puts [exec xsim tb_computer_smode_plic_irq_sim -runall]
