...
set prj_file [file join $sim_dir xsim_computer_ddr_sv32.prj]
...
add_sv $fh [file join $root src tb tb_computer_ddr_sv32.v]

close $fh

set batch_tcl [file join $sim_dir xsim_computer_ddr_sv32_batch.tcl]
...
puts "Elaborating computer DDR3 Sv32 simulation..."
