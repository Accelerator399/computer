...
puts [exec xelab tb_misaligned -debug typical --timescale 1ns/1ps --override_timeunit --override_timeprecision -s tb_misaligned_sim]
puts [exec xsim tb_misaligned_sim -runall]
