...
set srcs {
    ...
    src/tb/tb_core_branch_handoff.v
}
...
puts [exec xelab tb_core_branch_handoff -debug typical --timescale 1ns/1ps --override_timeunit --override_timeprecision -s tb_core_branch_handoff_sim]
puts [exec xsim tb_core_branch_handoff_sim -runall]
