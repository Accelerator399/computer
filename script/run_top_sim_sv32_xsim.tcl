...
puts [exec xelab tb_top_sim_sv32 -debug typical --timescale 1ns/1ps --override_timeunit --override_timeprecision -s tb_top_sim_sv32_sim]
puts [exec xsim tb_top_sim_sv32_sim -runall]
